export const appErrorMessages = {
  ...
  AI_PROVIDER_UNAVAILABLE: '无法连接本机 Ollama，请确认服务已经启动。',
  AI_MODEL_NOT_FOUND: '本机没有找到所选模型，请先在 Ollama 中安装。',
  AI_REQUEST_TIMEOUT: '本地模型响应超时，请缩短文本或稍后重试。',
  AI_REQUEST_FAILED: '本地模型生成失败，请稍后重试。',
  AI_OUTPUT_INVALID: '模型没有返回可用内容，请重试。',
