...
`BookRepository`, `ReaderSettingsRepository`, `AnnotationRepository`, and
`NoteRepository` follow this boundary. SQLite implementations validate write
...
content and derived plain text for future search; Tiptap runtime objects never
